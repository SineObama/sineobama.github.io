...
原文：[excel中提取中文拼音_牛老师讲GIS的博客-CSDN博客_excel提取拼音公式](https://blog.csdn.net/GISShiXiSheng/article/details/44566307)

**该方法存在缺点，无法识别多音字，还存在一些错误拼音。**

主要步骤：

alt+F11调出vba编写窗口，写入以下函数：
